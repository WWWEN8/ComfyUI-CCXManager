...
CCXManag辅助节点很好解决小伙伴的使用SD-PPP节点升级后痛点，CCXManag设置完运行一次，插件自动记忆你设置的信息，下次重启COMFYUI自动运行CCXManag节点，无论SD-PPP节点是否有升级，Photoshop插件照样同步更新的。使用CCXManag节点，完全摆脱手动去Photoshop更新插件了。
